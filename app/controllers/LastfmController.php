...
class LastfmController extends BaseController
{
     ...
     *
     * @param array   $results Result array from Last.fm
     * @param integer $number  Number of result array requested
     *
     * @return array
     */
     ...
     *
     * @param \Illuminate\Queues\Jobs $job  Job details for the queue
     * @param array                   $data Array containing the optimisation level and image location
     *
     * @return  void
     */
    public function optimiseImage($job, $data)
    {
        ...
        // The difference of time in seconds between starting and finishing optimisation
